            ...
            <div class="-mx-4 sm:-mx-12 px-12 sm:px-8 py-4 overflow-x-auto">
                ...
                >
                    <table class="min-w-full leading-normal">
                        ...
                        <tr>
                            <th
                                class="px-8 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider"
                            >
                                Image
                            </th>
                            <th
                        ...
                        @forelse($products as $product)
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    ...
                                    <a href="{{ route('seller.products.show',$product) }}">Show</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
